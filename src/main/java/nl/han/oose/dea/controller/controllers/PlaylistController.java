...
public class PlaylistController {
    ...
    public ResponseEntity<PlaylistsDTO> acquirePlaylists(@RequestParam("token") String token) {
        return ResponseEntity.ok().body(playlistDAO.getPlaylistsDTO(token));
    }

    @RequestMapping(method = RequestMethod.DELETE, value = "/{id}", produces = MediaType.APPLICATION_JSON_VALUE)

    public ResponseEntity<PlaylistsDTO> deletePlaylist(@RequestParam("token") String token, @PathVariable int id) {
    ...
    public ResponseEntity<PlaylistsDTO> addPlaylist(@RequestParam("token") String token, PlaylistDTO playlistDTO) {
    ...
    public ResponseEntity<PlaylistsDTO> editPlaylist(@RequestParam("token") String token, @PathVariable("id") int id, PlaylistDTO playlistDTO) {
    ...
    public ResponseEntity<TracksDTO> getAllTracksInPlaylist(@RequestParam("token") String token, @PathVariable("id") int id) {
    ...
    public ResponseEntity<TracksDTO> deleteTrackFromPlaylist(@RequestParam("token") String token, @PathVariable("playlistId") int playlistId, @PathVariable("trackId") int trackId) {
    ...
    public ResponseEntity<TracksDTO> addTrackToPlaylist(@RequestParam("token") String token, @PathVariable("id") int playlistId, TrackDTO trackDTO) {
